...
def google_login_callback(request):
  ...
  if not social_account:
    ...
    return redirect (f'{os.getenv('FRONTEND_URL')}/login/callback/?error=NoSocialAccount')
  ...
  if token:
    ...
    return redirect (f'{os.getenv('FRONTEND_URL')}/login/callback/?access_token={access_token}')
