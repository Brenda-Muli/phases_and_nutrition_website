...
function App() {
  ...
  if (loading) {
    // Optional loading spinner while authentication is being checked
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/home"
          element={isAuthorized ? <Home /> : <Navigate to="/login" replace />}
        />
...
const ProtectedLogin = () => {
  ...
  if (loading) {
    // Optional: Loading state while checking authorization
    return <div>Loading...</div>;
  }
