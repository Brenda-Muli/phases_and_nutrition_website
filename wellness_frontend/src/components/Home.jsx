...
function Home() {
  ...
  const toggleFAQ = (index) => {
    ...
    return (
      ...
      <section className="flex flex-col items-center justify-start p-6 space-y-6">
  {/* Left Side (always full-width) */}
  <motion.div
  ...
  {/* FAQ Items - Ensure One Column */}
  <motion.div
    className="w-full space-y-4 cursor-pointer mb-4"
    initial={{ opacity: 0, x: 50 }}
    animate={{ opacity: 1, x: 0 }}
  ...
  >
    ...
    <motion.div
      ...
      onClick={() => toggleFAQ(1)}
    >
      <p className="font-semibold text-lg text-[#470a1f] bg-gradient-to-r from-[#fde6e9] to-[#fbd0d9] pb-4 rounded-md pl-4 pt-2 ">
        What is a normal menstrual cycle, and how can I track it?
      </p>
      <motion.p
    ...
    >
      <p className="font-semibold text-lg text-[#470a1f] bg-gradient-to-r from-[#fde6e9] to-[#fbd0d9] pb-4 rounded-md pl-4 pt-2 ">
        What are the symptoms of PMS, and how can I manage them?
      </p>
      <motion.p
        className="text-md text-[#801b40]"
        initial={{ opacity: 0 }}
        ...
        transition={{ duration: 0.3 }}
      >
         PMS(Premenstrual Syndrome) includes symptoms like bloating, cramps, mood swings, fatigue, and breast tenderness. You can manage PMS by maintaining a balanced diet, exercising regularly, staying hydrated, and using pain relief for cramps. Stress reduction through relaxation techniques can also help ease emotional symptoms.
      </motion.p>
    </motion.div>
    ...
    >
      <p className="font-semibold text-lg text-[#470a1f] bg-gradient-to-r from-[#fde6e9] to-[#fbd0d9] pb-4 rounded-md pl-4 pt-2 ">
        Why is my period irregular, and is it something to worry about?
      </p>
      <motion.p
        className="text-md text-[#801b40]"
        initial={{ opacity: 0 }}
    ...
    >
      <p className="font-semibold text-lg text-[#470a1f] bg-gradient-to-r from-[#fde6e9] to-[#fbd0d9] pb-4 rounded-md pl-4 pt-2 ">
        How can I know if something is wrong with my period?
      </p>
      <motion.p
        className="text-md text-[#801b40]"
        initial={{ opacity: 0 }}
    ...
    >
      <p className="font-semibold text-lg text-[#470a1f] bg-gradient-to-r from-[#fde6e9] to-[#fbd0d9] pb-4 rounded-md pl-4 pt-2 ">
        How does my menstrual cycle affect my health, mood, and energy levels?
      </p>
      <motion.p
        className="text-md text-[#801b40]"
        initial={{ opacity: 0 }}
